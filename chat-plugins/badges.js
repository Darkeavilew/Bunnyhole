...
exports.commands = {
	...
	badges: function (target, room, user) {
		...
		case 'set':
			...
			this.privateModAction(user.name + " gave the '" + selectedBadge + "' badge to " + userid + ".");
		...
		case 'take':
			...
			userBadges = userBadges.filter(b => b !== selectedBadge);
			Db('userBadges').set(userId, userBadges);
			this.privateModAction(user.name + " took the '" + selectedBadge + "' badge from " + userId + ".");
		...
		case 'delete':
			...
			this.privateModAction(user.name + " removed the '" + selectedBadge + "' badge.");
			break;
		case 'user':
